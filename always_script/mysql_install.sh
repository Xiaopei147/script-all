...
yum -y install libaio.so.1 libaio.*

if [ $? -ne 0 ]
then
    wget https://dev.mysql.com/get/Downloads/MySQL-5.7/mysql-5.7.31-linux-glibc2.12-x86_64.tar.gz -P /data/software
else
...
then
    ...
    mv /data/software/mysql-5.7.31-linux-glibc2.12-x86_64  /usr/local/mysql
fi
